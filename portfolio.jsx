      ...
      <section id="about" style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", position: "relative", zIndex: 1, padding: "0 24px" }}>
        <div style={{ textAlign: "center", maxWidth: 750 }}>
          ...
          <p style={{ fontSize: "17px", color: "#94a3b8", maxWidth: 520, margin: "0 auto 36px", lineHeight: 1.7, fontWeight: 300 }}>
            CS student building at the intersection of hardware, math research, and software. I make things work — from graph theory to Arduino to embedded systems.
          </p>
            ...
            <FadeIn delay={0.2}>
              <Card style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                <div>
                  ...
                  {["Arduino Uno", "Raspberry Pi", "PIC24 Microcontroller", "MPLabs IDE"].map(t => (
                    <span key={t} className="tag">{t}</span>
                  ))}
                </div>
                <div>
                  <h3 style={{ fontFamily: "'Syne', sans-serif", fontSize: "18px", marginBottom: "16px" }}>Domains</h3>
                  {["Graph Theory", "Embedded Systems", "Robotics", "Math Research", "Software Dev"].map(t => (
                    <span key={t} className="tag">{t}</span>
                  ))}
                </div>
                <div>
                  <h3 style={{ fontFamily: "'Syne', sans-serif", fontSize: "18px", marginBottom: "16px" }}>Tools</h3>
                  {["Git", "Linux", "MS Office", "Callermax"].map(t => (
                    <span key={t} className="tag">{t}</span>
                  ))}
                </div>
              </Card>
          ...
          <div className="grid-2">
            <FadeIn delay={0.15}>
              <Card>
                ...
                <h3 style={{ fontFamily: "'Syne', sans-serif", fontSize: "17px", marginBottom: "10px" }}>Driver Alertness Monitor</h3>
                <p style={{ fontSize: "14px", color: "#94a3b8", lineHeight: 1.65 }}>
                  Built a motor-based heart rate and eye-state detector that detects drowsiness or intoxication and takes precautionary action — with Arduino and Lego robotics.
                </p>
                <div style={{ marginTop: "16px" }}>
                  <span className="tag">Arduino</span><span className="tag">C++</span><span className="tag">Robotics</span>
                </div>
              </Card>
            </FadeIn>
